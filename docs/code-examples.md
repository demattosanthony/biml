Title: Code examples - IfcOpenShell 0.8.0 documentation
...
## Get all wall types[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-all-wall-types "Link to this heading")
...
## Get all door occurrences of a type[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-all-door-occurrences-of-a-type "Link to this heading")
...
## Get the type of a wall[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-the-type-of-a-wall "Link to this heading")
...
## Get the properties of a wall type[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-the-properties-of-a-wall-type "Link to this heading")
...
## Find the spatial container of an element[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#find-the-spatial-container-of-an-element "Link to this heading")
...
## Get all elements in a container[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-all-elements-in-a-container "Link to this heading")
...
## Get the XYZ coordinates of a element[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-the-xyz-coordinates-of-a-element "Link to this heading")
...
## Get the geometry of an element[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-the-geometry-of-an-element "Link to this heading")

See [Geometry processing](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_processing.html) for details.

## Get the classification of an element[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-the-classification-of-an-element "Link to this heading")
...
## Convert to and from SI units and project units[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#convert-to-and-from-si-units-and-project-units "Link to this heading")
...
## Get the distribution system of an element[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#get-the-distribution-system-of-an-element "Link to this heading")
...
## Copy an entity instance[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#copy-an-entity-instance "Link to this heading")
...
## Create a simple model from scratch[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#create-a-simple-model-from-scratch "Link to this heading")
...
![Image 8: ../_images/simple-model.png](https://docs.ifcopenshell.org/_images/simple-model.png)

## Create a work schedule constructing a building floor by floor[¶](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html#create-a-work-schedule-constructing-a-building-floor-by-floor "Link to this heading")
...
work_schedule\=work_schedule, name\=name, predefined_type\="CONSTRUCTION")
    ...
    \# Give it a time
    task\_time \= ifcopenshell.api.sequence.add\_task\_time(model, task\=task)

    \# Arbitrarily set the task's scheduled time duration to be 1 week
    ifcopenshell.api.sequence.edit\_task\_time(model, task\_time\=task\_time,
    ...
    if predecessor:
        ifcopenshell.api.sequence.assign\_sequence(model, relating\_process\=predecessor, related\_process\=task)
...
for storey in storeys:
    ...
    task \= add\_task(model, f"Construct {storey.Name}", task, schedule)

    \# Assign all the products in that storey to the task as construction outputs.
    for product in get\_decomposition(storey):
        ifcopenshell.api.sequence.assign\_product(model, relating\_product\=product, related\_object\=task)
...
![Image 9: ../_images/simple-work-schedule.png](https://docs.ifcopenshell.org/_images/simple-work-schedule.png)
