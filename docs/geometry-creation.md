# Geometry creation - IfcOpenShell 0.8.0 documentation
...
## General concepts[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#general-concepts "Link to this heading")
...
![Image 3: ../_images/representation-contexts.png](https://docs.ifcopenshell.org/_images/representation-contexts.png)A **Representation** contains one or more **Representation Items**. Each **Representation Item** could be an extrusion, a mesh, a surface, a curve, and so on depending on the type of geometric modeling technique. Techniques cannot be mixed, so a single **Representation** may be made out of multiple extrusion **Items** but cannot have both extrusions and meshes.
...
## Object placements[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#object-placements "Link to this heading")
...
![Image 4: ../_images/object-placement.png](https://docs.ifcopenshell.org/_images/object-placement.png)The recommended way to set an **Object Placement** is to specify the placement as a 4x4 matrix. You can use the `numpy` library to create and edit matrices. A 4x4 matrix looks like this:
...
![Image 5: ../_images/object-placement-example.png](https://docs.ifcopenshell.org/_images/object-placement-example.png)Here’s how we might do the same operation with Python code:
...
## Representation contexts[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#representation-contexts "Link to this heading")
...
## Representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#representations "Link to this heading")
...
## Mesh representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#mesh-representations "Link to this heading")
...
![Image 6: ../_images/mesh-representation.png](https://docs.ifcopenshell.org/_images/mesh-representation.png)

## Wall representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#wall-representations "Link to this heading")
...
![Image 8: ../_images/wall-2pt-representation.png](https://docs.ifcopenshell.org/_images/wall-2pt-representation.png)

## Profile representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#profile-representations "Link to this heading")
...
![Image 10: ../_images/arbitrary-profile.png](https://docs.ifcopenshell.org/_images/arbitrary-profile.png)Once you have created your profile, you can add a representation which uses that profile as its cross section. Profiles are always extruded in the +Z direction. So if you want to have a beam, you will need to rotate the **Object Placement** to place the element on its side.
...
![Image 11: ../_images/profile-representation.png](https://docs.ifcopenshell.org/_images/profile-representation.png)

## Custom representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#custom-representations "Link to this heading")
...
2.  Optionally convert your outer and optional inner curves into a profile. This is only necessary if you want to give your profile a name (so that you may reuse it and manage it in a profile library) or if you have inner curves.
3.  Optionally extrude your profile into a solid. If you are creating 2D representations, then extrusion is not necessary.
4.  Optionally move your extruded solid into your desired location through translation, rotation, or mirroring.
5.  Convert all your extruded solids (or just curves, if 2D) into a **Representation** with a **Representation Context**.
...
![Image 12: ../_images/custom-representation.png](https://docs.ifcopenshell.org/_images/custom-representation.png)Another really common case for using the shape builder is when creating **Representations** of reinforcement bars, cables, or circular railings. IFC has a special type of extrusion specifically for extruding a disk (i.e. circle) along a path. This should almost always be used for usecases like reinforcement bar.
...
![Image 13: ../_images/swept-disk-representation.png](https://docs.ifcopenshell.org/_images/swept-disk-representation.png)For more information, consult the shape builder documentation.

## OpenCASCADE representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#opencascade-representations "Link to this heading")
...
## Manual representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#manual-representations "Link to this heading")
...
![Image 14: ../_images/manual-representation.png](https://docs.ifcopenshell.org/_images/manual-representation.png)

## Types and mapped representations[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#types-and-mapped-representations "Link to this heading")
...
## Material layer sets[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#material-layer-sets "Link to this heading")
...
## Material profile sets[¶](https://docs.ifcopenshell.org/ifcopenshell-python/geometry_creation.html#material-profile-sets "Link to this heading")
