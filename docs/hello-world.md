Hello, world! - IfcOpenShell 0.8.0 documentation
...
[Download sample IFC](https://www.ifcwiki.org/images/e/e3/AC20-FZK-Haus.ifc)

See also

You can find more sample models online in the [OSArch Open Data Directory](https://wiki.osarch.org/index.php?title=AEC_Open_Data_directory)
...
This is only a small sample of the basic building blocks of manipulating IFC data. IFC comes with a huge utility library and API for performing common tasks. See [Code examples](https://docs.ifcopenshell.org/ifcopenshell-python/code_examples.html) for more.
