...
def capture_output(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            return {"output": output, "result": str(result) if result is not None else None, "error": None}
        except Exception as e:
            return {"output": temp_out.value.getvalue(), "result": None, "error": str(e) + "\n" + traceback.format_exc()}
        finally:
...
def execute_command(cmd):
    globals_dict = {"bpy": bpy, "print": print, "__builtins__": __builtins__}
        ...
        if event.type == "TIMER":
            while not command_queue.empty():
                ...
                try:
                    ...
                    error_msg = {"output": "", "result": None, "error": str(e) + "\n" + traceback.format_exc()}
